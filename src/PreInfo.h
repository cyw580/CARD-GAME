...
void previous(){
	...
	lib[4][9]={"[抛掷燃木]",4,130,-30,0,0,4};
	lib[4][10]={"[停战协议]",2,0,10,10,0,16};
	lib[4][11]={"[决斗]",4,225,0,0,0,0};
	lib[4][12]={"[绝对防御]",3,0,0,150,0,0};
	lib[4][13]={"[绝对防御]",3,0,0,150,0,0};
	lib[4][14]={"[小型急救包]",2,0,50,35,0,0};
	lib[4][15]={"[小型急救包]",2,0,50,35,0,0};
	lib[4][16]={"[更新装备]",2,0,0,20,0,25};
	libcnt[4]=16;
	job[4]={500,4,200,6};
	//goblin
	...
	lib[5][8]={"[防御训练]",2,0,0,25,0,19};
	lib[5][9]={"[全能训练]",3,30,20,10,0,19};
	lib[5][10]={"[全能训练]",3,30,20,10,0,19};
	lib[5][11]={"[潜伏攻击]",1,15,0,0,0,20};
	...
	lib[6][8]={"[虚空物质]",3,130,30,15,0,30};
	lib[6][9]={"[黑暗气息]",0,20,0,0,0,0};
	lib[6][10]={"[虚空能量]",4,175,40,0,0,30};
	lib[6][11]={"[暗能涌动]",3,100,45,0,10,0};
	lib[6][12]={"[暗能爆发]",4,125,35,0,10,0};
