...
void previous(){
	...
	lib[1][7]={"[无中生有]",0,0,0,0,0,7};
	lib[1][8]={"[仓储建设]",4,0,10,40,0,8};
	lib[1][9]={"[生命果]",3,0,80,0,0,9};
	...
	lib[4][10]={"[停战协议]",2,0,20,10,0,16};
	lib[4][11]={"[停战协议]",2,0,20,10,0,16};
	lib[4][12]={"[决斗]",4,225,0,0,0,0};
	lib[4][13]={"[绝对防御]",3,0,0,150,0,0};
	lib[4][14]={"[绝对防御]",3,0,0,150,0,0};
	lib[4][15]={"[小型急救包]",2,0,60,35,0,0};
	lib[4][16]={"[小型急救包]",2,0,60,35,0,0};
	lib[4][17]={"[更新装备]",2,0,0,30,0,25};
	libcnt[4]=17;
	job[4]={500,4,200,6};
	//goblin
