...
string Card::Intro(){
	...
	else if(func==4)return "对方被点燃3回合（击破护盾时才生效）";
	else if(func==5)return "自身获得狂暴至回合结束（清除虚弱）";
	else if(func==6)return "对方中毒3回合（职业为地精或击破护盾时才生效）";
	...
	else if(func==14)return "对方下回合获得狂暴（清除虚弱）";
	else if(func==15)return "消耗所有费用，造成（35*费用+25）的伤害";
	else if(func==16)return "对方-3◆";
	else if(func==17)return "你在本回合、对方在下回合都获得狂暴（清除虚弱）";
	...
	else if(func==49)return "对方下回合变得虚弱（清除狂暴）";
	else if(func==50)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==51)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==52)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==53)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==54)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==55)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==56)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
	else if(func==57)return "清空对手手牌中[神圣意志] 对手获得等量<★信仰>";
...
void previous(){
	...
	lib[3][11]={"[不稳定元素]",2,145,40,0,40,35};
	...
	lib[6][4]={"[虚空魔法]",1,25,20,20,0,30};
    lib[6][5]={"[暗影炸弹]",5,220,20,30,0,29};
    lib[6][6]={"[虚空凝聚]",1,0,0,0,0,28};
    lib[6][7]={"[虚空之力]",2,100,0,0,0,30};
    lib[6][8]={"[虚空物质]",3,110,30,15,0,30};
    lib[6][9]={"[黑暗气息]",0,20,0,0,0,0};
    lib[6][10]={"[虚空能量]",4,155,40,0,0,30};
    ...
    lib[6][17]={"[虚空重生]",1,0,45,0,0,31};
    lib[6][18]={"[虚空休养]",2,0,80,0,0,33};
    libcnt[6]=18;
	job[6]={400,4,40,5};
	lib[7][1]={"[意念控制]",2,40,0,0,0,38};//将对手牌库的一张牌清除特效后刷入牌库
	lib[7][2]={"[治疗光环]",2,0,50,0,0,39};//双方获得2回合治疗
	lib[7][3]={"[不完全记忆]",1,0,10,0,20,40};//将对手牌库的一张牌清除特效和MISS后放入手牌
	lib[7][4]={"[意念斗争]",3,100,0,20,0,38};
	lib[7][5]={"[意识反馈]",1,0,0,0,0,41};//此牌在手牌中时，你每出一张牌ATK+9(无论是否MISS)
	...
	lib[7][13]={"[说教]",1,10,0,0,0,49};//对方下回合虚弱
	libcnt[7]=13;
